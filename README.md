...
| Notifier Version | CakePHP Version | PHP Version | Branch     | Status      |
|-----------------|-----------------|-------------|------------|-------------|
| 3.x             | 3.10+           | >=5.4.16    | cakephp3   | Maintained  |
| 4.x             | 4.x             | >=7.4       | cakephp4   | Active      |

**Installation by CakePHP version:**

For CakePHP 3.x projects:
```bash
composer require jdominguezpaz/notifier:~3.2.3
```

For CakePHP 4.x projects:
```bash
composer require jdominguezpaz/notifier:~4.0.2
```
